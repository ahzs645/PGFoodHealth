...
def geocode_fields(record):
    return {
        ...
        "google_geocode_quality": record.get("google_geocode_quality"),
        "google_geocode_quality_issues": record.get("google_geocode_quality_issues"),
        "google_expected_city_distance_km": record.get("google_expected_city_distance_km"),
    }
...
def water_row(record, dataset, index, source_file):
    return {
        ...
        "source_notice_type": record.get("notice_type") or record.get("advisory"),
        "source_start_date": record.get("start_date"),
        "source_details_url": record.get("details_url"),
        **geocode_fields(record),
    }
